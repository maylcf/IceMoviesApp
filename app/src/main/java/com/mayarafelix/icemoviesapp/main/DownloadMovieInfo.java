...
public class DownloadMovieInfo extends AsyncTask<String, Void, Movie>
{
    private final WeakReference<MainActivity> activityReference;
    private int position;

    public DownloadMovieInfo(@NonNull MainActivity appActivity, int position)
    {
    ...
    protected void onPostExecute(@Nullable Movie movie)
    {
        ...
        activity.updateMovieDetailReturn(movie, position);
    }
}
